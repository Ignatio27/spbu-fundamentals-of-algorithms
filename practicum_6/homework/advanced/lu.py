...
def run_test_cases(n_runs: int, path_to_homework: str) -> dict[str, Performance]:
    ...
    with open(os.path.join("/Users/ignat/Desktop/pershin_homework/spbu-fundamentals-of-algorithms/",path_to_homework, "matrices.yaml"), "r") as f:
    ...
    for i, matrix_filename in enumerate(matrix_filenames):
        ...
        A = (
            scipy.io.mmread(os.path.join("/Users/ignat/Desktop/pershin_homework/spbu-fundamentals-of-algorithms/",path_to_homework, "matrices", matrix_filename))
            .todense()
            .A
        )
        b = np.ones((A.shape[0],))
